...
public class MyArrayListPublicTester {
    ...
    /**
     * Tests add method when an element is inserted at the beginning
     */
    @Test
    public void testAdd() {
        listWithInt.add(0, 10);
        listDefaultCap.add(0, 10);
    ...
    /**
     * Tests shiftToEnd on examples from write-up.
     */
    @Test
    public void testShiftToEnd() {
        ...
        // Example 2
        Integer[] arr2 = new Integer[]{1, 3, 4, 5, 2, null};
